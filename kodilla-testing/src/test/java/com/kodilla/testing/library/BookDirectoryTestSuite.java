...
public class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOfZeroBooks() {
        ...
        LibraryUser libraryUser= new LibraryUser("Kris","Kraw", "8410");// [4]
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(resultListOfBooks);// [13]

        // When
        List<Book> theListOfBooks = bookLibrary.listBooksInHandsOf(libraryUser);        // [14]
    ...
    void testListBooksInHandsOfOneBook() {
        ...
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);                  // [3]
        List<Book> resultListOfBooks = new ArrayList<>();
        Book book1=new Book("Potop", "Sienkiewicz", 2000);
    ...
    void testListBooksInHandsOfFiveBooks() {
        ...
        Book book5=new Book("Potop", "Sienkiewicz", 2000);
        resultListOfBooks.add(book1);
